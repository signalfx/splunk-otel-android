...
/**
 * Very simple example of making an instrumented Volley http request. This class leverages
 * the Splunk Android Volley instrumentation.
 */
public class VolleyExample {
    ...
    public void doHttpRequest() {
        ...
        VolleyTracing volleyTracing = VolleyTracing.builder(splunkRum)
        ...
        Request<?> request = new StringRequest(GET, URL, response -> {
            ...
            public Map<String, String> getHeaders() {
                ...
                extraHeaders.put("X-Android-Instrumentation-Example", "splunk-otel-android");
                return extraHeaders;
            }
        };
        queue.add(request);
    ...
    /**
     * Creates and returns a simple non-caching RequestQueue for demo purposes.
     * Volley users are expected to know how to create their own
     * request queue (see https://google.github.io/volley/requestqueue.html).
     * The main demonstration point here is how the network is created using
     * the HurlStack obtained from VolleyTracing.
     * @param hurlStack - A HurlStack obtained from VolleyTracing
     * @return a newly created and started RequestQueue. It is the responsibility
     * of the caller to stop the queue when finished.
     */
    private static RequestQueue buildRequestQueue(HurlStack hurlStack) {
        ...
        RequestQueue queue =
                new RequestQueue(cache, network, 1,
