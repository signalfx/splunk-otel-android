...
public class SplunkRum {
    ...
    static final AttributeKey<String> APPLICATION_ID_KEY = stringKey("app.application_id");
    static final AttributeKey<String> APP_VERSION_CODE_KEY = stringKey("app.version_code");
    static final AttributeKey<String> SPLUNK_OLLY_UUID_KEY = stringKey("app.o11y.key");
