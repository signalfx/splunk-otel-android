...
gradlePlugin {
    plugins {
        create("androidInstrumentationPlugin") {
            id = "$defaultGroupId.${artifactPrefix}okhttp3-plugin"
            implementationClass = "com.splunk.rum.okhttp3.plugin.OkHttp3InstrumentationPlugin"
...
publishing {
    publications {
        withType(MavenPublication::class.java) {
            ...
            artifactId = "${artifactPrefix}okhttp3-plugin"
