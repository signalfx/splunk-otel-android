...
package com.splunk.rum.okhttp3.plugin
 ...
 * and needed dependencies for automatic instrumentation of HTTP request made via OkHttp3 APIs.
 */
class OkHttp3InstrumentationPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        addBytebuddyPluginForOkhttp3NRTracing()
        addDependenciesForOkhttp3NRTracing()
    }

    private fun addBytebuddyPluginForOkhttp3NRTracing() {
    ...
    private fun addDependenciesForOkhttp3NRTracing() {
        project.dependencies.add("byteBuddy", "io.opentelemetry.android:instrumentation-okhttp-3.0-agent:$dependenciesVersion")
    }
}