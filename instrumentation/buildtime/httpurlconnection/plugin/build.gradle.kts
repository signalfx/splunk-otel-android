...
gradlePlugin {
    plugins {
        create("androidInstrumentationPlugin") {
            id = "$defaultGroupId.${artifactPrefix}httpurlconnection-plugin"
            implementationClass = "com.splunk.rum.httpurlconnection.plugin.HttpURLInstrumentationPlugin"
...
publishing {
    publications {
        withType(MavenPublication::class.java) {
            ...
            artifactId = "${artifactPrefix}httpurlconnection-plugin"
