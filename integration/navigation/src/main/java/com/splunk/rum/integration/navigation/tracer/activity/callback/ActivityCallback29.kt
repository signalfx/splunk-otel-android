...
internal class ActivityCallback29(override val tracer: ActivityTracerManager) : ActivityCallback {
    ...
    override fun onActivityPreCreated(activity: Activity, savedInstanceState: Bundle?) {
        ...
        tracer.startActivityCreation(activity).addEvent(RumConstant.NAVIGATION_ACTIVITY_PRE_CREATED_EVENT)
    }

    override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) {
        Logger.d("ActivityCallback29", "onActivityCreated")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_CREATED_EVENT)
    }

    override fun onActivityPostCreated(activity: Activity, savedInstanceState: Bundle?) {
        Logger.d("ActivityCallback29", "onActivityPostCreated")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_POST_CREATED_EVENT)
    }

    override fun onActivityPreStarted(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityPreStarted")
        tracer.initiateRestartSpanIfNecessary(activity).addEvent(RumConstant.NAVIGATION_ACTIVITY_PRE_STARTED_EVENT)
    }

    override fun onActivityStarted(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityStarted")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_STARTED_EVENT)
    }

    override fun onActivityPostStarted(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityPostStarted")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_POST_STARTED_EVENT)
    }
    ...
    override fun onActivityPreResumed(activity: Activity) {
        ...
        tracer.startSpanIfNoneInProgress(activity, RumConstant.NAVIGATION_RESUMED_SPAN_NAME)
            .addEvent(RumConstant.NAVIGATION_ACTIVITY_PRE_RESUMED_EVENT)
    }

    override fun onActivityResumed(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityResumed")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_RESUMED_EVENT)
    }

    override fun onActivityPostResumed(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityPostResumed")
        tracer
            .addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_POST_RESUMED_EVENT)
    ...
    override fun onActivityPrePaused(activity: Activity) {
        ...
        tracer.startSpanIfNoneInProgress(activity, RumConstant.NAVIGATION_PAUSED_SPAN_NAME)
            .addEvent(RumConstant.NAVIGATION_ACTIVITY_PRE_PAUSED_EVENT)
    }

    override fun onActivityPaused(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityPaused")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_PAUSED_EVENT)
    }

    override fun onActivityPostPaused(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityPostPaused")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_POST_PAUSED_EVENT).endActiveSpan()
    }
    ...
    override fun onActivityPreStopped(activity: Activity) {
        ...
        tracer.startSpanIfNoneInProgress(activity, RumConstant.NAVIGATION_STOPPED_SPAN_NAME)
            .addEvent(RumConstant.NAVIGATION_ACTIVITY_PRE_STOPPED_EVENT)
    }

    override fun onActivityStopped(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityStopped")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_STOPPED_EVENT)
    }

    override fun onActivityPostStopped(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityPostStopped")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_POST_STOPPED_EVENT).endActiveSpan()
    }
    ...
    override fun onActivityPreDestroyed(activity: Activity) {
        ...
        tracer.startSpanIfNoneInProgress(activity, RumConstant.NAVIGATION_DESTROYED_SPAN_NAME)
            .addEvent(RumConstant.NAVIGATION_ACTIVITY_PRE_DESTROYED_EVENT)
    }

    override fun onActivityDestroyed(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityDestroyed")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_DESTROYED_EVENT)
    }

    override fun onActivityPostDestroyed(activity: Activity) {
        Logger.d("ActivityCallback29", "onActivityPostDestroyed")
        tracer.addEvent(activity, RumConstant.NAVIGATION_ACTIVITY_POST_DESTROYED_EVENT).endActiveSpan()
    }
}
